...
t_missionMenu = {
	...
	{id = '', text = 'True Kung Fu Spirit',  varID = textImgNew(), varText = mission2Progress},
	{id = '', text = '                 BACK'},
}
...
t_mInfo = {
	...
	{id = '2', text = "Use the full power of Kung Fu Man!         "},
}
for i=1, #t_mInfo do
...
function f_missionMenu()
	...
	data.missionsStatus = (math.floor(((data.mission1Status + data.mission2Status) * 100 / 200) + 0.5)) --The number (200) is the summation of all data.missionStatus values in parentheses
