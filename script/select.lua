...
function f_selectReset()
	...
	if data.p2Faces then
		...
		offsetRows = 3 --Number of Character Select Hidden Slots below
...
function f_selectSimple()
	p1SelX = 0
	p1SelY = 0
	p2SelX = 1 --Cursor position after choosing the Game Mode (Single, Team or Turns), this is used to put p2 in the 4th slot
	p2SelY = 0
	p1FaceOffset = 0
	p2FaceOffset = 0
	p1OffsetRow = 0
...
elseif data.winscreen == 'Fixed' then
	...
	if winner == 1 then
		...
		if data.gameMode == 'arcade' and data.missionNo == 'mission 2' then
